...
export class DashboardComponent implements OnInit, AfterContentInit, AfterViewChecked {
  @ViewChild('wrapper_1')
  wrapper_1: ElementRef;
  @ViewChild('wrapper_2')
  wrapper_2: ElementRef;
  @ViewChild('wrapper_3')
  wrapper_3: ElementRef;
    ...
    this.sideDrawerService.getSelectEntity().subscribe(selectedEntity => {
      ...
      if (entity !== -1) {
        ...
        if (selectedEntity['attr'].length <= 5) {
          this.entitiesContent['_results'][entity].nativeElement.style.height = (selectedEntity['attr'].length * 43) + 'px';
        } else {
          this.entitiesContent['_results'][entity].nativeElement.style.height = '214px';
        }
      }
  ...
  resizeWrappers() {
    if (window.screen.height >= (this.wrapper_2.nativeElement.offsetHeight + 146)) {
      this.wrapper_1.nativeElement.style.height = (window.screen.height - 156) + 'px';
      this.wrapper_1.nativeElement.style.width = this.wrapper_2.nativeElement.offsetWidth + 'px';
      this.wrapper_3.nativeElement.style.height = (window.screen.height - 156) + 'px';
      this.wrapper_3.nativeElement.style.width = this.wrapper_2.nativeElement.offsetWidth + 'px';
    } else {
      this.wrapper_1.nativeElement.style.height = (this.wrapper_2.nativeElement.offsetHeight + 50) + 'px';
      this.wrapper_1.nativeElement.style.width = this.wrapper_2.nativeElement.offsetWidth + 'px';
      this.wrapper_3.nativeElement.style.height = (this.wrapper_2.nativeElement.offsetHeight + 50) + 'px';
      this.wrapper_3.nativeElement.style.width = this.wrapper_2.nativeElement.offsetWidth + 'px';
    }
  }
  ...
  renderEntity(stageName, entity, attributeId) {
    ...
    entityInd = _.findIndex(this.entitiesContent['_results'], x => {
      return (x.nativeElement.id === 'entity_content_' + entity.id);
    });

    if (entityInd !== -1) {
      if (this.entitiesContent['_results'][entityInd].nativeElement.style.height === 'auto') {
        this.entitiesContent['_results'][entityInd].nativeElement.style.height = '214px';
        this.toggleEntityExpand = false;
      }
    }
  ...
  renderLoopEntity(stageName, entity, attrId) {
    ...
    if (entity !== -1) {
      ...
      if (counter <= 5) {
        ...
        this.entitiesContent['_results'][entityIndex].nativeElement.style.height = '214px';
      }
    }
              ...
              attribute.relationOut.forEach(rel => {
                ...
                if (element_to) {
                  if (
                    ...
                    (stg === 'sor' && (rel.stage === 'staging' || rel.stage === 'landing')) ||
                    (stg === 'mart' && (rel.stage === 'sor' || rel.stage === 'staging' || rel.stage === 'landing'))
                  ) {
                  ...
                  `;
                    ...
                    (stg === 'landing' && (rel.stage === 'staging' || rel.stage === 'sor' || rel.stage === 'mart')) ||
                    (stg === 'staging' && (rel.stage === 'sor' || rel.stage === 'mart')) ||
        ...
        attribute.relationOut.forEach(rel => {
          ...
          if (element_to[0]) {
            if (
              ...
              (stage === 'sor' && (rel.stage === 'staging' || rel.stage === 'landing')) ||
              (stage === 'mart' && (rel.stage === 'sor' || rel.stage === 'staging' || rel.stage === 'landing'))
            ) {
            ...
            `;
              ...
              (stage === 'landing' && (rel.stage === 'staging' || rel.stage === 'sor' || rel.stage === 'mart')) ||
              (stage === 'staging' && (rel.stage === 'sor' || rel.stage === 'mart')) ||
